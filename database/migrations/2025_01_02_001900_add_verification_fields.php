...
return new class {
    public function up(\PDO $pdo): void
    {
        ...
        if ($driver === 'mysql') {
            ...
            $investorQueries = [
                "ALTER TABLE investors ADD COLUMN nid_document_path VARCHAR(255) NULL",
                "ALTER TABLE investors ADD COLUMN police_verification_path VARCHAR(255) NULL",
                "ALTER TABLE investors ADD COLUMN nid_verified_at TIMESTAMP NULL",
                "ALTER TABLE investors ADD COLUMN police_verified_at TIMESTAMP NULL"
            ];
        } else {
            $customerQueries = [
            ...
            $investorQueries = [
                "ALTER TABLE investors ADD COLUMN nid_document_path TEXT NULL",
                "ALTER TABLE investors ADD COLUMN police_verification_path TEXT NULL",
                "ALTER TABLE investors ADD COLUMN nid_verified_at TEXT NULL",
                "ALTER TABLE investors ADD COLUMN police_verified_at TEXT NULL"
            ];
        }

        foreach (array_merge($customerQueries, $employeeQueries, $investorQueries) as $sql) {
            try {
                $pdo->exec($sql);
